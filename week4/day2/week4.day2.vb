...
int num[]={1,2,3,3,4,3}list---allows the duplicate values--->listget(5)--->3
int num[]={1,2,3,4}--->set--->get()--->differs
String s="welcome";output:celmow-->3-->m
linked--->outut:Welcom-->3--c
implementations:
1)HashSet--->random 
2)treeset--->ascii
...
2)no duplicates
3)get() method is not used bec order of the elemnt depends on implementation classes.
